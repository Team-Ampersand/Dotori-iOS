...
let dependencies = Dependencies(
    ...
    swiftPackageManager: SwiftPackageManagerDependencies(
        [
            .remote(url: "https://github.com/Yummypets/YPImagePicker.git", requirement: .exact("5.2.2")),
            ...
            .remote(url: "https://github.com/GSM-MSG/Emdpoint.git", requirement: .exact("3.4.0")),
